...
**My research document for this project can be found [here](https://docs.google.com/document/d/1o-Q0pz6iqu4vaHzS23wI_lMs1zmFNPZRMnCMZFzLiM4/edit?usp=sharing)**

![From the Putting on Protest newsroom page](/assets/work/putting_on_protest_gif.gif)
...
- [Dynamic Diversity, Equity, Inclusion, and Belonging](https://cca.edu/newsroom/sf-design-week-award/) - Won an [SF Design Week Award](https://sfdesignweek.org/awards/a-makers-approach-to-deib/)
- [CCA Glance](https://cca.edu/glance/)
- Newsroom: [Creative Citizenship on Campus](https://cca.edu/newsroom/creative-citizenship-on-campus/)
- Newsroom: [Bay Area Scholastic Art Awards](https://cca.edu/newsroom/bay-area-art-writing-awards/)
- Newsroom: [Putting on Protest](https://cca.edu/newsroom/putting-on-protest/)

Please note that these links may not be active, as CCA's impending closure may result in the unpublishing on content.

The following is a full-length screenshot of the DEIB page on .EDU, designed in Vev. 
